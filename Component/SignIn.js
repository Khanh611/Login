...
import { StyleSheet, Text, View, Image, ImageBackground, TextInput, TouchableOpacity, ViewComponent } from 'react-native';
      ...
      <ImageBackground source={bgImage} style={styles.backgroundContainer}>
          ...
          <View style={styles.box}>
            ...
            <View style={{alignItems: 'center', justifyContent: 'center'}}>
              <TouchableOpacity style={[styles.loginBtn, {backgroundColor:"#fb5b5a"}]}>
                <Text style={styles.loginText}>Sign in</Text>
              </TouchableOpacity>

              <Text style={[styles.loginText, { fontSize: 14, textAlign: "center"}]}>or</Text>

              <TouchableOpacity style={[styles.loginBtn, {backgroundColor:"white",}]}>
                <View style={{flexDirection:'row'}}>
                  <Image source={require('../images/iconfb.png')} style={{width:20 ,height:20, marginHorizontal:10 }}></Image>
